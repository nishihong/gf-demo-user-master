...
// LoginLogDao is the data access object for table yjs_login_log.
...
// LoginLogColumns defines and stores column names for table yjs_login_log.
type LoginLogColumns struct {
	Id        string //
	Username  string //
	UserId    string //
	LoginType string // 登录方式，1云加速，2官网
	LoginIp   string // 登录ip
	CreatedAt string //
	UpdatedAt string //
}

//  loginLogColumns holds the columns for table yjs_login_log.
