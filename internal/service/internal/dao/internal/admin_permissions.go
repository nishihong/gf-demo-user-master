...
// AdminPermissionsColumns defines and stores column names for table yjs_admin_permissions.
...
//  adminPermissionsColumns holds the columns for table yjs_admin_permissions.
...
func NewAdminPermissionsDao() *AdminPermissionsDao {
	return &AdminPermissionsDao{
		group:   "default",
		table:   "yjs_admin_permissions",
