...
// AdminRoleMenuColumns defines and stores column names for table yjs_admin_role_menu.
...
//  adminRoleMenuColumns holds the columns for table yjs_admin_role_menu.
