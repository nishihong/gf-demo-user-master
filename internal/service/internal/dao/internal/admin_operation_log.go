...
// AdminOperationLogColumns defines and stores column names for table yjs_admin_operation_log.
...
//  adminOperationLogColumns holds the columns for table yjs_admin_operation_log.
...
func NewAdminOperationLogDao() *AdminOperationLogDao {
	return &AdminOperationLogDao{
		group:   "default",
		table:   "yjs_admin_operation_log",
