...
// ProductTypeDao is the data access object for table yjs_product_type.
...
// ProductTypeColumns defines and stores column names for table yjs_product_type.
...
//  productTypeColumns holds the columns for table yjs_product_type.
