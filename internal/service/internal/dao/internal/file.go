...
// FileDao is the data access object for table yjs_file.
type FileDao struct {
...
// FileColumns defines and stores column names for table yjs_file.
type FileColumns struct {
	Id        string //
	FileName  string // 文件名
	FileSize  string // 文件大小
	FileExt   string // 文件格式
	FilePath  string // 文件所在的文件夹
	FileMd5   string //
	UpdatedAt string //
	CreatedAt string //
	FileUrl   string // url
...
//  fileColumns holds the columns for table yjs_file.
